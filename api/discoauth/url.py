...
class auth:
    ...
    def url(self) -> str:
        ...
        redirectUri = htmlEncode(redirect_uri)
        url = joinUrl(client_id, _scope, redirectUri, state)
...
class discord:
    ...
    def token(self, code) -> dict[str, str]:
...
class permissions:
    ...
    def add(self, permissions: int | str | List[int | str]) -> None:
        """
    ...
    def remove(self, permissions: int | str | List[int | str]) -> None:
        """
    ...
    def general(self) -> None:
        ...
        self.value = permsByList(perm_list)

    def allChannel(self) -> None:
    ...
    def stage_moderator(self) -> None:
        perm_list = [4, 22, 24]
        self.value = permsByList(perm_list)

    def elevated(self) -> None:
